var unitFn = {
    ...
    unit_4_Fn: function() {
        ...
        function unitLesson_1_Fn() {
            ...
            function exerciseFn_4() {
                ...
                $(".unit_4_lesson_1 .exercise4 .clikBox").click(function(){
                    ...
                    totalSelectedLine = $(".unit_4_lesson_1 .exercise4 .match_box .line:visible").length;

                    $(".unit_4_lesson_1 .exercise4 .match_box .line").each(function(){
                ...
                $(".unit_4_lesson_1 .exercise4 .reload").off("click").on("click", function() {
                    $(".unit_4_lesson_1 .exercise4 .two_box_number .image_area .redCircle").removeClass('selected');
                    $(".unit_4_lesson_1 .exercise4 .match_box .line").hide();
                    line_start = '';
                    line_end = '';
                    seventeenCircle = false;
                    sixteenCircle = false;
        ...
        function unitLesson_3_Fn() {
            ...
            function exerciseFn_4() {
                ...
                var line_end = '';
                var totalSelectedLine = 0;
                $(".unit_4_lesson_3 .exercise4 .clikBox").click(function(){
                    if($(this).hasClass('leftMatch')) {
                        line_start = $(this).data('id');
                    } else {
                        line_end = $(this).data('id');
                    ...
                    totalSelectedLine = $(".unit_4_lesson_3 .exercise4 .match_box .line:visible").length;

                    $(".unit_4_lesson_3 .exercise4 .match_box .line").each(function(){
                        if($(this).data('id') === line_start + '_' + line_end && totalSelectedLine < 2) {
                            $(this).show();
                            line_start = '';
                            line_end = '';
                ...
                $(".unit_4_lesson_3 .exercise4 .reload").off("click").on("click", function() {
                    $(".unit_4_lesson_3 .exercise4 .water_drop .drop").removeClass('selected');
                    $(".unit_4_lesson_3 .exercise4 .match_box .line").hide();
                    line_start = '';
                    line_end = '';
                    waterdrop = 0;
                    firedrop = 0;
    ...
    unit_5_Fn: function() {
        ...
        function unitLesson_2_Fn() {
            ...
            function exerciseFn_2() {
                var DNDCorrectAns = ["Circle", "Triangle", "Rectangle"];
                var isUserCorrect = true;
                $(".unit_5_lesson_2 .exercise2 .dragArea .dragBox > img").draggable({
                    containment: ".unit_5_lesson_2 .exercise2",
                    zIndex: 10000,
                    revert: function(event, ui) {
                        $(this).data("uiDraggable").originalPosition = {
                            top: 0,
                ...
                $(".unit_5_lesson_2 .exercise2 .dropBox").droppable({
                    drop: function(event, ui) {
                        var tempBool = $(this).hasClass("hasDroped");
                        if (tempBool) {
                            ui.draggable.mouseup();
                ...
                $("#unit_5_lesson_2_exe_3").off("click").on("click", function() {

                    $(".unit_5_lesson_2 .exercise2 .dropable_box").each(function(k, v) {
                        var tempVal = $(v).find("p").html();
                        if (tempVal != DNDCorrectAns[k]) {
                            isUserCorrect = false;
                        }
                ...
                $(".unit_5_lesson_2 .exercise2 .reload").off("click").on("click", function() {
                    $(".unit_5_lesson_2 .exercise2 .dragBox img").removeAttr("style").css("position", "relative");
                    $(".unit_5_lesson_2 .exercise2 .dropable_box").each(function(k, v) {
                        $(v).find("p").html(DNDCorrectAns[k]).css("opacity", "0.1");
                        $(v).removeClass("hasDroped");
                    })
                ...
                $(".unit_5_lesson_2 .exercise2 .close_popup").off("click").on("click", function() {
                    if (!isUserCorrect) {
                        $(".unit_5_lesson_2 .exercise2 .dragBox img").removeAttr("style").css("position", "relative");
                        $(".unit_5_lesson_2 .exercise2 .dropable_box").each(function(k, v) {
                            $(v).find("p").html(DNDCorrectAns[k]).css("opacity", "0.1");
            ...
            function exerciseFn_3() {
                ...
                $(".unit_5_lesson_2 .exercise3 .row1").on('click', function() {                    
                    $(this).toggleClass("color1");
                });
                $(".unit_5_lesson_2 .exercise3 .row2").on('click', function() {
                    $(this).toggleClass("color2");
                });
                $(".unit_5_lesson_2 .exercise3 .row3").on('click', function() {
                    $(this).toggleClass("color3");
                });
                $(".unit_5_lesson_2 .exercise3 .submit_btn").off("click").on("click", function() {
                    var temp1 = $(".row1.color1").length;
                    var temp2 = $(".row2.color2").length;
                    var temp3 = $(".row3.color3").length;


                    if (temp1 == 3 && temp2 == 3 && temp3 == 2) {
                        isUserCorrectThree = true;
                    ...
                    if (isUserCorrectThree == true) {
                        $(".unit_5_lesson_2 .exercise3 .feedback_box").show();
                        $(".unit_5_lesson_2 .exercise3 .overlay").show();
                        $(".unit_5_lesson_2 .exercise3 .feedback_box .right_feedback").show();
                    } else {
                        $(".unit_5_lesson_2 .exercise3 .feedback_box").show();
                        $(".unit_5_lesson_2 .exercise3 .overlay").show();
                        $(".unit_5_lesson_2 .exercise3 .feedback_box .wrong_feedback").show();
                    }

                });

                $(".unit_5_lesson_2 .exercise3 .close_popup").off("click").on("click", function() {

                    if (isUserCorrectThree == false) {
                        $(".unit_5_lesson_2 .exercise3 .row1").removeClass("color1");
                        $(".unit_5_lesson_2 .exercise3 .row2").removeClass("color2");
                        $(".unit_5_lesson_2 .exercise3 .row3").removeClass("color3");

                    }
                    $(".unit_5_lesson_2 .exercise3 .feedback_box").hide();
                    $(".unit_5_lesson_2 .exercise3 .right_feedback").hide();
                    $(".unit_5_lesson_2 .exercise3 .wrong_feedback").hide();
                    $(".unit_5_lesson_2 .exercise3 .overlay").hide();

                });

                $(".unit_5_lesson_2 .exercise3 .reload").off("click").on("click", function() {
                    $(".unit_5_lesson_2 .exercise3 .row1").removeClass("color1");
                    $(".unit_5_lesson_2 .exercise3 .row2").removeClass("color2");
                    $(".unit_5_lesson_2 .exercise3 .row3").removeClass("color3");
            ...
            function exerciseFn_4() {
                ...
                $(".unit_5_lesson_2 .exercise4 .submit_btn").on("click", function() {                   
                    ...
                    if (FirstVal_1 === "1" && FirstVal_2 === "3" && FirstVal_3 === "2" && FirstVal_4 === "4" && FirstVal_5 === "2" && FirstVal_6 === "3") {
                        isUserCorrectOne = true;
                    } else {
                        isUserCorrectOne = false;
                    }
                    if (isUserCorrectOne) {
                        $(".unit_5_lesson_2 .exercise4 .feedback_box").show();
                        $(".unit_5_lesson_2 .exercise4 .overlay").show();
                        $(".unit_5_lesson_2 .exercise4 .right_feedback").show();

                    } else {
                        $(".unit_5_lesson_2 .exercise4 .feedback_box").show();
                        $(".unit_5_lesson_2 .exercise4 .overlay").show();
                        $(".unit_5_lesson_2 .exercise4 .wrong_feedback").show();

                    }
                });
                $(".unit_5_lesson_2 .exercise4 .close_popup").off("click").on("click", function() {
                    if (isUserCorrectOne == false) {
                        $('.unit_5_lesson_2 .exercise4 .input_area_box input').each(function() {
                            $(this).val('');
                        });
                    }
                    $(".unit_5_lesson_2 .exercise4 .feedback_box").hide();
                    $(".unit_5_lesson_2 .exercise4 .right_feedback").hide();
                    $(".unit_5_lesson_2 .exercise4 .wrong_feedback").hide();
                    $(".unit_5_lesson_2 .exercise4 .overlay").hide();
                });

                $(".unit_5_lesson_2 .exercise4 .reload").on('click', function() {
                    $('.unit_5_lesson_2 .exercise4 .input_area_box input').each(function() {
                        $(this).val('');
                    });
                });
    ...
    unit_6_Fn: function() {
        ...
        function unitLesson_1_Fn() {
            ...
            function exerciseFn_2() {
                var isUserCorrectOne = false;
                $(".unit_6_lesson_1 .exercise2 .box1 .chack").click(function(){
                    $(".unit_6_lesson_1 .exercise2 .box1 .chack").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_1 .exercise2 .box2 .chack").click(function(){
                    $(".unit_6_lesson_1 .exercise2 .box2 .chack").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_1 .exercise2 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_6_lesson_1 .exercise2 .check_box1").hasClass('selected') && $(".unit_6_lesson_1 .exercise2 .check_box4").hasClass('selected') ?  true : false;
                ...
                $(".unit_6_lesson_1 .exercise2 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_1 .exercise2 .feedback_box, .unit_6_lesson_1 .exercise2 .overlay, .unit_6_lesson_1 .exercise2 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_1 .exercise2 .reload").on('click', function() {
                    $(".unit_6_lesson_1 .exercise2 .chack").removeClass('selected');
                });
            }

            function exerciseFn_3() {
                var isUserCorrectOne = false;
                $(".unit_6_lesson_1 .exercise3 .box_uper .box1 .selectedArea").click(function(){
                    $(".unit_6_lesson_1 .exercise3 .box_uper .box1 .selectedArea").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_1 .exercise3 .box_uper .box2 .selectedArea").click(function(){
                    $(".unit_6_lesson_1 .exercise3 .box_uper .box2 .selectedArea").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_1 .exercise3 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_6_lesson_1 .exercise3 .full_box .box1 .selectedArea.small").hasClass('selected') && $(".unit_6_lesson_1 .exercise3 .full_box .box2 .selectedArea.small2").hasClass('selected') ?  true : false;
                ...
                $(".unit_6_lesson_1 .exercise3 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_1 .exercise3 .feedback_box, .unit_6_lesson_1 .exercise3 .overlay, .unit_6_lesson_1 .exercise3 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_1 .exercise3 .reload").on('click', function() {
                    $(".unit_6_lesson_1 .exercise3 .box_uper .selectedArea").removeClass('selected');
                });
            }
        ...
        function unitLesson_2_Fn() {
            ...
            function exerciseFn_2() {
                var isUserCorrectOne = false;
                $(".unit_6_lesson_2 .exercise2 .numberPanel .numberRow > div").click(function(){
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_2 .exercise2 .submit_btn").on('click', function() {
                    const selectedDot = $(".unit_6_lesson_2 .exercise2 .numberPanel .numberRow div.selected").length
                    isUserCorrectOne = selectedDot === 60 ?  true : false;
                ...
                $(".unit_6_lesson_2 .exercise2 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_2 .exercise2 .feedback_box, .unit_6_lesson_2 .exercise2 .overlay, .unit_6_lesson_2 .exercise2 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_2 .exercise2 .reload").on('click', function() {
                    $(".unit_6_lesson_2 .exercise2 .numberPanel .numberRow div").removeClass('selected');
                });
            }
            ...
            function exerciseFn_3() {
                ...
                $(".unit_6_lesson_2 .exercise3 .dotline_area .dotline").click(function(){
                    var selectedDot = false;
                    if($(this).hasClass('line1_dot')){
                        $(this).addClass('selected');
                    } else {
                ...
                $(".unit_6_lesson_2 .exercise3 .submit_btn").on('click', function() {
                    const selectedDot = $(".unit_6_lesson_2 .exercise3  .dotline_area .dotline.selected").length;
                ...
                $(".unit_6_lesson_2 .exercise3 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_2 .exercise3 .feedback_box, .unit_6_lesson_2 .exercise3 .overlay, .unit_6_lesson_2 .exercise3 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_2 .exercise3 .reload").on('click', function() {
                    $(".unit_6_lesson_2 .exercise3 .dotline_area .dotline, .unit_6_lesson_2 .exercise3 .dotline_area .singleline").removeClass('selected');
                });
            }
            ...
            function exerciseFn_4() {
                ...
                var textbox5 = '';
                var textbox6 = '';
                $(".unit_6_lesson_2 .exercise4 .submit_btn").on('click', function() {
                    textbox1 = $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox1").val();
                    textbox2 = $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox2").val();
                    textbox3 = $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox3").val();
                    textbox4 = $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox4").val();
                    textbox5 = $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox5").val();
                    textbox6 = $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox6").val();
                    isUserCorrectOne = textbox1 === '50' && textbox2 === '52' && textbox3 === '54' && textbox4 === '56' && textbox5 === '58' && textbox6 === '60' ?  true : false;
                ...
                $(".unit_6_lesson_2 .exercise4 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_2 .exercise4 .feedback_box, .unit_6_lesson_2 .exercise4 .overlay, .unit_6_lesson_2 .exercise4 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_2 .exercise4 .reload").on('click', function() {
                    $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox1").val('');
                    $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox2").val('');
                    $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox3").val('');
                    $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox4").val('');
                    $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox5").val('');
                    $(".unit_6_lesson_2 .exercise4 .numberRow input.textbox6").val('');
                });
            }
        }
        ...
        function unitLesson_3_Fn() {
            ...
            function exerciseFn_2() {
                ...
                var isUserCorrectOne = false;
                $(".unit_6_lesson_3 .exercise2 .topBox .leftImgBox .selectedArea").click(function(){
                    $(".unit_6_lesson_3 .exercise2 .topBox .leftImgBox .selectedArea").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_3 .exercise2 .topBox .rightImgBox .selectedArea").click(function(){
                    $(".unit_6_lesson_3 .exercise2 .topBox .rightImgBox .selectedArea").removeClass('selected');
                    $(this).addClass('selected');
                });

                $(".unit_6_lesson_3 .exercise2 .dregArea img").draggable({ revert: "invalid" });
                $(".unit_6_lesson_3 .exercise2 .dropArea").droppable({
                    drop: function( event, ui ) {
                        $(this).addClass( "selected" );
                      }
                });

                $(".unit_6_lesson_3 .exercise2 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_6_lesson_3 .exercise2 .topBox .leftImgBox .selectedArea.object1").hasClass('selected') && $(".unit_6_lesson_3 .exercise2 .topBox .rightImgBox .selectedArea.object2").hasClass('selected') && $(".unit_6_lesson_3 .exercise2 .bottomBox .dropArea").hasClass('selected') ?  true : false;
                ...
                $(".unit_6_lesson_3 .exercise2 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_3 .exercise2 .feedback_box, .unit_6_lesson_3 .exercise2 .overlay, .unit_6_lesson_3 .exercise2 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_3 .exercise2 .reload").on('click', function() {
                    $(".unit_6_lesson_3 .exercise2 .topBox .imageBox .selectedArea, .unit_6_lesson_3 .exercise2 .bottomBox .dropArea").removeClass('selected');
                    $(".unit_6_lesson_3 .exercise2 .bottomBox .dregArea img").animate({top: "0px", left: "0px"});
                });
            }

            function exerciseFn_3() {
                var isUserCorrectOne = false;
                $(".unit_6_lesson_3 .exercise3 .leftImgBox .chack").click(function(){
                    $(".unit_6_lesson_3 .exercise3 .leftImgBox .chack").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_3 .exercise3 .rightImgBox .chack").click(function(){
                    $(".unit_6_lesson_3 .exercise3 .rightImgBox .chack").removeClass('selected');
                    $(this).addClass('selected');
                });

                $(".unit_6_lesson_3 .exercise3 .dregArea img").draggable({ revert: "invalid" });
                $(".unit_6_lesson_3 .exercise3 .dropArea").droppable({
                    drop: function( event, ui ) {
                        $(this).addClass( "selected" );
                      }
                });

                $(".unit_6_lesson_3 .exercise3 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_6_lesson_3 .exercise3 .check_box2").hasClass('selected') && $(".unit_6_lesson_3 .exercise3 .check_box3").hasClass('selected') && $(".unit_6_lesson_3 .exercise3 .bottomBox .dropArea").hasClass('selected') ?  true : false;
                ...
                $(".unit_6_lesson_3 .exercise3 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_3 .exercise3 .feedback_box, .unit_6_lesson_3 .exercise3 .overlay, .unit_6_lesson_3 .exercise3 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_3 .exercise3 .reload").on('click', function() {
                    $(".unit_6_lesson_3 .exercise3 .chack, .unit_6_lesson_3 .exercise3 .bottomBox .dropArea").removeClass('selected');
                    $(".unit_6_lesson_3 .exercise3 .bottomBox .dregArea img").animate({top: "0px", left: "0px"});
                });
            }

            function exerciseFn_4() {
                var isUserCorrectOne = false;
                $(".unit_6_lesson_3 .exercise4 .fullContainer .absImage").click(function(){
                    $(this).addClass('selected');
                });

                $(".unit_6_lesson_3 .exercise4 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_6_lesson_3 .exercise4 .fullContainer .absImage.selected").length === 6 ?  true : false;
                ...
                $(".unit_6_lesson_3 .exercise4 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_3 .exercise4 .feedback_box, .unit_6_lesson_3 .exercise4 .overlay, .unit_6_lesson_3 .exercise4 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_3 .exercise4 .reload").on('click', function() {
                    $(".unit_6_lesson_3 .exercise4 .fullContainer .absImage").removeClass('selected');
                });
            }
        }
        ...
        function unitLesson_4_Fn() {
            ...
            function exerciseFn_2() {
                var isUserCorrectOne = false;
                $(".unit_6_lesson_4 .exercise2 .numberPanel .numberRow > div").click(function(){
                    $(this).addClass('selected');
                });
                $(".unit_6_lesson_4 .exercise2 .submit_btn").on('click', function() {
                    const selectedDot = $(".unit_6_lesson_4 .exercise2 .numberPanel .numberRow div.selected").length
                    isUserCorrectOne = selectedDot === 70 ?  true : false;
                ...
                $(".unit_6_lesson_4 .exercise2 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_4 .exercise2 .feedback_box, .unit_6_lesson_4 .exercise2 .overlay, .unit_6_lesson_4 .exercise2 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_4 .exercise2 .reload").on('click', function() {
                    $(".unit_6_lesson_4 .exercise2 .numberPanel .numberRow div").removeClass('selected');
                });
            }
            ...
            function exerciseFn_3() {
                ...
                $(".unit_6_lesson_4 .exercise3 .submit_btn").on('click', function() {
                    textbox1 = $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox1").val();
                    textbox2 = $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox2").val();
                    textbox3 = $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox3").val();
                    textbox4 = $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox4").val();
                    textbox5 = $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox5").val();
                    isUserCorrectOne = textbox1 === '61' && textbox2 === '63' && textbox3 === '65' && textbox4 === '67' && textbox5 === '69' ?  true : false;
                ...
                $(".unit_6_lesson_4 .exercise3 .close_popup").off("click").on("click", function() {
                    $(".unit_6_lesson_4 .exercise3 .feedback_box, .unit_6_lesson_4 .exercise3 .overlay, .unit_6_lesson_4 .exercise3 .wrong_feedback").hide();
                });

                $(".unit_6_lesson_4 .exercise3 .reload").on('click', function() {
                    $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox1").val('');
                    $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox2").val('');
                    $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox3").val('');
                    $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox4").val('');
                    $(".unit_6_lesson_4 .exercise3 .text_box_area input.textbox5").val('');
                });
            }
    ...
    unit_7_Fn: function() {
        ...
        function unitLesson_4_Fn() {
            ...
            function exerciseFn_3() {
                var isUserCorrectOne = false;
                $(".unit_7_lesson_4 .exercise3 .box1 .chack").click(function(){
                    $(".unit_7_lesson_4 .exercise3 .box1 .chack").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_7_lesson_4 .exercise3 .box2 .chack").click(function(){
                    $(".unit_7_lesson_4 .exercise3 .box2 .chack").removeClass('selected');
                    $(this).addClass('selected');
                });
                $(".unit_7_lesson_4 .exercise3 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_7_lesson_4 .exercise3 .check_box2").hasClass('selected') && $(".unit_7_lesson_4 .exercise3 .check_box3").hasClass('selected') ?  true : false;
                ...
                $(".unit_7_lesson_4 .exercise3 .close_popup").off("click").on("click", function() {
                    $(".unit_7_lesson_4 .exercise3 .feedback_box, .unit_7_lesson_4 .exercise3 .overlay, .unit_7_lesson_4 .exercise3 .wrong_feedback").hide();
                });

                $(".unit_7_lesson_4 .exercise3 .reload").on('click', function() {
                    $(".unit_7_lesson_4 .exercise3 .chack").removeClass('selected');
                });
            }

            function exerciseFn_4() {
                var isUserCorrectOne = false;
                $(".unit_7_lesson_4 .exercise4 .fullContainer .absImage").click(function(){
                    $(this).addClass('selected');
                });

                $(".unit_7_lesson_4 .exercise4 .submit_btn").on('click', function() {
                    isUserCorrectOne = $(".unit_7_lesson_4 .exercise4 .fullContainer .absImage.selected").length === 8 ?  true : false;
                ...
                $(".unit_7_lesson_4 .exercise4 .close_popup").off("click").on("click", function() {
                    $(".unit_7_lesson_4 .exercise4 .feedback_box, .unit_7_lesson_4 .exercise4 .overlay, .unit_7_lesson_4 .exercise4 .wrong_feedback").hide();
                });

                $(".unit_7_lesson_4 .exercise4 .reload").on('click', function() {
                    $(".unit_7_lesson_4 .exercise4 .fullContainer .absImage").removeClass('selected');
                });
            }
        }
